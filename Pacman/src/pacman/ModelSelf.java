...
public class ModelSelf extends JPanel implements ActionListener{
	private Dimension d; // 視窗大小
	private final Font smallFont = new Font("Arial", Font.BOLD, 14); // press space to start 字體
	private boolean inGame = false;
	private boolean dying = false;
	
	private final int BLOCK_SIZE = 24; // 一格的大小
	private final int N_BLOCKS = 15; // 一邊有幾格(15 x 15)
